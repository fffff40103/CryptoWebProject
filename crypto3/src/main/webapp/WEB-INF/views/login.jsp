     ...
     <div class="login">
      <form class="text-center form-border" action="./login" method="post">
        <h2 class="text-center">Welcome back</h2>
           <!--輸入帳號-->
          <input class="inputaccount formRWD" name="username" id="username" type="text" placeholder="Username" autocomplete="off" >     
          <br>
          <!--輸入密碼的小圖示，案眼睛可以隱藏密碼再點擊一下可以顯示密碼-->
          <div class="password">
              <input class="inputpassword formRWD" name="password" id="password" type="password" placeholder="Password" autocomplete="off" >
          ...
          <br>
          <button class="logingoogle formRWD" type="submit">Login with Google</button>
          <br>
          <!--這裡設定如果沒有帳號要註冊的地方-->
